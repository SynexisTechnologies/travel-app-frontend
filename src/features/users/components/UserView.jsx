...
const UserView = ({ open, onClose, userData, onEdit }) => {
              ...
              >
                <Row gutter={[16, 0]}>
                  <Col xs={12} md={6}>
                    <InfoItem
                      label="Created"
                      value={formatDateTime(userData.addeddatetime)}
                      icon={
                  ...
                  <Col xs={12} md={6}>
                    <InfoItem
                      label="Last Login"
                      value={formatDateTime(userData.loggeddatetime)}
                      icon={
                        <ClockCircleOutlined style={{ fontSize: "14px" }} />
                      }
                    />
                  ...
                  <Col xs={12} md={6}>
                    <InfoItem
                      label="Last Modified"
                      value={formatDateTime(userData.lastmodifieddatetime)}
                      icon={
                        <ClockCircleOutlined style={{ fontSize: "14px" }} />
                      }
                    />
